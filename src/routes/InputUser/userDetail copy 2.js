...
export default class userDetial extends Component {
  ...
  handleDel = () => {
    ...
    // validateFields(["dataSource"], (errors, values) => {
    //   this.setState(
    //     {
    //       dataSource: values.dataSource.filter((item) => item.checked !== true),
    //     },
    //     () => {
    //       console.log(242, this.state);
    //       form.setFieldsValue({
                ...
                {dataSource.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {getFieldDecorator(`dataSource[${index}]["type"]`, {
                          rules: [
                            {
                              required: true,
                              message: "请输入主体类型",
                        ...
                        })(<Input type="text" placeholder="请输入主体类型" />)}
                      </FormItem>
                      <FormItem
                        label="客户名称"
                        hasFeedback
                      ...
                      >
                        {getFieldDecorator(`dataSource[${index}]["certId"]`, {
                          rules: [
                            {
                              required: true,
                              message: "请输入身份证号",
                      ...
                      >
                        {getFieldDecorator(
                          `dataSource[${index}]["companyAddress"]`,
                          {
                            rules: [
                              {
                                required: true,
                      ...
                      >
                        {getFieldDecorator(
                          `dataSource[${index}]["residenceAddress"]`,
                          {
                            rules: [
                              {
                                required: true,
                      ...
                      >
                        {getFieldDecorator(`dataSource[${index}]["checked"]`, {
