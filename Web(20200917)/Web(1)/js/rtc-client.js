class RtcClient {
  constructor(options) {
    ...
    console.log(171771717, "options", options, this.members_);
  ...
  async join() {
    ...
    try {
      ...
      try {
        ...
        console.log(7474747, this.userId_);
      } catch (e) {
  ...
  handleEvents() {
    ...
    this.client_.on("peer-join", (evt) => {
      ...
      console.log(201, 201, 201, "peer-join ", userId);

      //调接口获取用户名称数组，去进行筛选arr

      if (userId !== shareUserId) {
        //添加用户 userid
        addMemberView(userId, [{ aa: 1 }]);
      }
    });
    ...
    this.client_.on("stream-subscribed", (evt) => {
      ...
      // console.log(250250250, remoteStream.userId_);
      //添加远程小视频
      addVideoView(id, remoteStream.userId_);
      ...
      console.log(260, "stream-subscribed ID: ", id);
    });
